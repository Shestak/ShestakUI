...
L.unitframe_plugins_reputation_bar_desc = "Включить индикатор репутации (слева от игрока по наведению курсора)"
L.unitframe_plugins_experience_bar = "Индикатор опыта"
L.unitframe_plugins_experience_bar_desc = "Включить индикатор опыта (слева от игрока по наведению курсора)"
L.unitframe_plugins_artifact_bar = "Индикатор Азерита"
L.unitframe_plugins_artifact_bar_desc = "Включить индикатор Азерита (слева от игрока по наведению курсора)"
...
L.misc_click_cast_desc = "Позволяет назначить на клавиши мыши заклинания (аналог Clique). Настройка через боковую закладку в книге заклинаний"
...
L_GUI_MISC_LAG_TOLERANCE = "Автоматическое обновление допустимой задержки"