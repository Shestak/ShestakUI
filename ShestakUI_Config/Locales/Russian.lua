...
L.raidframe_auto_position = "Авто размер рейда (только для раскладки 'Лекарь')"
...
L.tooltip_item_count = "Количество предметов в стопке"
...
L.automation_auto_collapse = "Сворачивать отслеживание заданий в подземельях"
L.automation_auto_collapse_reload = "Всегда сворачивать отслеживание заданий после экрана загрузки"
