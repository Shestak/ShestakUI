...
L.misc_hide_bg_spam_desc = "Скрываются сообщения о захвате, потере точек на полях боя Арати и Гилнеас" -- Need review
...
L_GUI_UF_PLUGINS_REPUTATION_BAR = "Включить индикатор репутации (слева от игрока по наведению курсора)"
L_GUI_UF_PLUGINS_EXPERIENCE_BAR = "Включить индикатор опыта (слева от игрока по наведению курсора)"
L_GUI_UF_PLUGINS_ARTIFACT_BAR = "Включить индикатор Азерита (слева от игрока по наведению курсора)"
L_GUI_UF_PLUGINS_SMOOTH_BAR = "Плавное изменение полос"
L_GUI_UF_PLUGINS_ENEMY_SPEC = "Отображать специализацию врага на полях боя и Арене"
