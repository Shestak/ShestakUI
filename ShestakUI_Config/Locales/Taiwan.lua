...
L.raidframe_raid_groups_vertical = "竪向排列團隊隊伍(僅在HPS佈局中生效)" -- Needs review
L.raidframe_raid_groups_vertical_desc = "竪向排列團隊隊伍(僅在HPS佈局中生效)" -- Needs review
...
L.raidframe_auto_position = "玩家/目標框架自動定位 (僅在HPS佈局非竪向排列时生效)" -- Need review
L.raidframe_auto_position_desc = "當小隊數目大於5，框架位置按小隊數目調整" -- Need review
