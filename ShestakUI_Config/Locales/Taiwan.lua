...
L.unitframe_plugins_reputation_bar_desc = "聲望條(玩家框架左側滑鼠懸停顯示)"
L.unitframe_plugins_experience_bar = "經驗條"
L.unitframe_plugins_experience_bar_desc = "經驗條(玩家框架左側滑鼠懸停顯示)"
L.unitframe_plugins_artifact_bar = "神器能量條"
L.unitframe_plugins_artifact_bar_desc = "神器能量條(玩家框架左側滑鼠懸停顯示)"
