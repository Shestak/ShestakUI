...
L_GUI_COMBATTEXT_HEAL_TRESHOLD = "治療承受信息/輸出最小閾值"
...
L_GUI_TOOLTIP_TALENTS = "提示資訊中顯示天賦"
L_GUI_TOOLTIP_ACHIEVEMENTS = "提示資訊中顯示成就比較"
L_GUI_TOOLTIP_TARGET = "提示資訊中顯示目標的目標"
L_GUI_TOOLTIP_TITLE = "提示資訊中顯示目標稱號"
L_GUI_TOOLTIP_RANK = "提示資訊中顯示公會階級"
L_GUI_TOOLTIP_ARENA_EXPERIENCE = "提示資訊中顯示競技場等級"
...
L_GUI_TOOLTIP_ITEM_TRANSMOGRIFY = "提示非幻化裝備"
...
L_GUI_UF_TOTAL_VALUE = "玩家與目標框體顯示詳細的文字變化"
...
L_GUI_UF_ICONS_PVP = "滑鼠懸停玩家/目標時,顯示PVP狀態文字"
