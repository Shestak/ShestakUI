...
L_GUI_AUTOMATION_AUTO_COLLAPSE_RELOAD = "Comprimi automaticamente l’ObjectiveTrackerFrame dopo un ricaricamento" review
...
L_GUI_SKINS_ARH = "Attiva il restyling di Archaeology Helper"
...
L_GUI_NAMEPLATE_CLAMP = "Aggancia le barre delle unità in cima allo schermo quando sono fuori portata visiva" review
