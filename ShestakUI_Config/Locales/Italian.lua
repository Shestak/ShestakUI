...
----------------------------------------------------------------------------------------
L_GUI_BUTTON_RESET = "Ripristino totale interfaccia utente"
...
-- General options
L_GUI_GENERAL_AUTOSCALE = "Dimensione dell'interfaccia automatica"
L_GUI_GENERAL_MULTISAMPLE = "Protezione del multisampling (bordi di 1 pixel)"
L_GUI_GENERAL_UISCALE = "Scala dell'interfaccia (se la dimensione automatica è disabilitata)"
...
L_GUI_MISC_AUTOBUYREAGENTS = "Auto-acquista i reagenti"
...
L_GUI_COMBATTEXT_DAMAGE_STYLE = "Cambia il carattere (font) di base per danni/cure (è necessario riavviare il gioco)"
...
L_GUI_COMBATTEXT_ICON_SIZE = "Dimensioni delle icone dei danni (influenza anche le dimensioni del carattere (font) dei danni)"
...
L_GUI_COMBATTEXT_MAX_LINES = "Massimo numero di righe da ricordare in modalità 'scorrimento' (più righe = più memoria)"
...
L_GUI_COMBATTEXT_MERGE_AOE_SPAM_TIME = "Tempo in secondi in cui l'incantesimo/abilità a bersagli multipli sarà unito in un singolo messaggio"
...
L_GUI_COMBATTEXT_DIRECTION = "Direzione di scorrimento ('sù'(va in basso) o 'giù'(vai in alto))"
...
L_GUI_COOLDOWN_RAID = "Recuperi dell'incursione"
L_GUI_COOLDOWN_RAID_ENABLE = "Visualizza i recuperi dell'incursione"
L_GUI_COOLDOWN_RAID_HEIGHT = "Altezza delle barre dei recuperi dell'incursione"
L_GUI_COOLDOWN_RAID_WIDTH = "Larghezza delle barre dei recuperi dell'incursione(se l'icona è attiva, larghezza + 28)"
L_GUI_COOLDOWN_RAID_SORT = "Disposizione verso l'alto delle barre dei recuperi dell'incursione"
L_GUI_COOLDOWN_RAID_ICONS = "Icone dei recuperi dell'incursione"
L_GUI_COOLDOWN_RAID_IN_RAID = "Mostra i recuperi dell'incursione nelle aree dell'incursioni"
L_GUI_COOLDOWN_RAID_IN_PARTY = "Mostra i recuperi dell'incursione nelle aree da gruppo"
L_GUI_COOLDOWN_RAID_IN_ARENA = "Mostra i recuperi dell'incursione nelle aree dell'arena"
...
L_GUI_COOLDOWN_ENEMY_DIRECTION = "Direzione delle icone dei recuperi del nemico (DESTRA|SINISTRA|SOPRA|SOTTO)"
L_GUI_COOLDOWN_ENEMY_EVERYWHERE = "Mostra i recuperi del nemico in qualsiasi area"
L_GUI_COOLDOWN_ENEMY_IN_BG = "Mostra i recuperi del nemico nelle aree dei Campi di Battaglia"
L_GUI_COOLDOWN_ENEMY_IN_ARENA = "Mostra i recuperi del nemico nelle aree dell'arena"

-- Pulse cooldowns options
L_GUI_COOLDOWN_PULSE = "Recuperi con effetto 'pulse'"
...
L_GUI_CHAT_TABS_MOUSEOVER = "Linguette delle chats in mouseover"
...
L_GUI_MINIMAP_SIZE = "Dimensioni della mappa"
...
L_GUI_NAMEPLATE_GOOD_COLOR = "Colore delle barre delle unità quando il valore della minaccia è positivo per il tuo PG, a seconda se è difensore o assalitore/guaritore"
L_GUI_NAMEPLATE_NEAR_COLOR = "Colore per perdita/guadagno minaccia"
L_GUI_NAMEPLATE_BAD_COLOR = "Colore delle barre delle unità quando il valore della minaccia è negativo per il tuo PG, a seconda se è difensore o assalitore/guaritore"
...
L_GUI_ACTIONBAR_HOTKEY = "Mostra i nomi delle scorciatoie da tastiera sui bottoni"
...
L_GUI_ACTIONBAR_SPLIT_BARS = "Dividi la quinta barra in due barre da 6 bottoni ciascuna"
...
L_GUI_ACTIONBAR_RIGHTBARS_MOUSEOVER = "Barre sulla destra in mouseover"
L_GUI_ACTIONBAR_PETBAR_MOUSEOVER = "Barra famiglio in mouseover (solo con la barra famiglio orizzontale)"
...
L_GUI_ACTIONBAR_SHAPESHIFT_MOUSEOVER = "Barre mutaforma/postura/torem in mouseover"
...
L_GUI_UF_CASTBAR_TICKS = "Mostra delle tacchette (ticks) sulla barra del lancio di incantesimi/abilità (utili per alcune magie)"
...
L_GUI_UF_PLUGINS_ECLIPSE_BAR = "Attiva la barra equilibrio"
L_GUI_UF_PLUGINS_HOLY_BAR = "Attiva la barra potere sacro"
L_GUI_UF_PLUGINS_SHARD_BAR = "Attiva la barra poteri stregone/a"
L_GUI_UF_PLUGINS_RUNE_BAR = "Attiva la barra rune"
...
L_GUI_UF_PLUGINS_TOTEM_BAR = "Attiva la barra totem"
L_GUI_UF_PLUGINS_TOTEM_BAR_NAME = "Nome del totem"
L_GUI_UF_PLUGINS_REPUTATION_BAR = "Attiva la barra reputazioni"
L_GUI_UF_PLUGINS_EXPERIENCE_BAR = "Attiva la barra esperienza"
L_GUI_UF_PLUGINS_SMOOTH_BAR = "Barra animata"
...
L_GUI_UF_SHOW_RAID = "Mostra i riquadri dell'incursione"
...
L_GUI_TOP_PANEL_MOUSE = "Pannello superiore in mouseover"
