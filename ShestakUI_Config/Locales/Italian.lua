...
L_GUI_ANNOUNCEMENTS_ENEMY_TRINKETS = "Annuncia l'utilizzo di monili del nemico (funziona solo in arena)"
...
L_GUI_AUTOMATION_SOLVE_ARTIFACT = "Popup automatico ricostruzione manufatto"
...
L_GUI_METER_ENABLE = "Attiva il contatore dei danni (solo per ShestakUI_alDamageMeter)"
