...
L.raidframe_hide_health_value = "Gesundheitswert ausblenden (nur Heal-Layout)"
L.raidframe_auto_position = "Automatische Neupositionierung der Raid-Frames (nur Heal-Layout)"
