...
L_GUI_ANNOUNCEMENTS_FLASK_FOOD = "通告食物和合剂的用途 (/ffcheck)"
...
L.automation_solve_artifact = "自动弹出帮助框架"
...
L.automation_tab_binder = "Tab只选定玩家"
...
L.automation_buff_on_scroll = "使用鼠标滚轮施放Buffs"
