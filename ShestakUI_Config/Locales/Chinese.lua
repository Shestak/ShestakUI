...
L.unitframe_plugins_reputation_bar_desc = "声望条(玩家框架左侧鼠标悬停显示)"
L.unitframe_plugins_experience_bar = "经验条"
L.unitframe_plugins_experience_bar_desc = "经验条(玩家框架左侧鼠标悬停显示)"
L.unitframe_plugins_artifact_bar = "神器能量条"
L.unitframe_plugins_artifact_bar_desc = "神器能量条(玩家框架左侧鼠标悬停显示)"
