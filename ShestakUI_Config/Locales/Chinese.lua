...
L_GUI_THREAT_HIDE_SOLO = "仅在队伍/团队中开啟"
...
L_GUI_ACTIONBAR_BOTTOMBARS = "底部动作条数目(1 ~ 3)"
L_GUI_ACTIONBAR_RIGHTBARS = "右侧动作条数目(0 ~ 3)"
...
L_GUI_UF_PLUGINS_TALENTS = "敌对玩家天赋"
...
L_GUI_UF_PLUGINS_VENGEANCE_BAR = "复仇"
