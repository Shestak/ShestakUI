...
function T.UploadDBM()
	...
	DBT_PersistentOptions["DBM"].StartColorR = C.unitframe.uf_color[1]
	DBT_PersistentOptions["DBM"].StartColorG = C.unitframe.uf_color[2]
	DBT_PersistentOptions["DBM"].StartColorB = C.unitframe.uf_color[3]
	DBT_PersistentOptions["DBM"].EndColorR = C.unitframe.uf_color[1]
	DBT_PersistentOptions["DBM"].EndColorG = C.unitframe.uf_color[2]
	DBT_PersistentOptions["DBM"].EndColorB = C.unitframe.uf_color[3]
