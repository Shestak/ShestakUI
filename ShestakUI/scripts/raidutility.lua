...
CreateButton("ShowButton", RaidUtilityPanel, "SecureHandlerClickTemplate", RaidUtilityPanel:GetWidth() / 1.5, SettingsDB.Scale(18), "TOP", UIParent, "TOP", -300, 2, RAID_CONTROL, nil)
