...
L_MISC_ONECLICK_BUYOUT = "Shift-Click to buyout the selected item without confirmation" -- Needs review
L_MISC_ONECLICK_BID = "Shift-Click to bid on the selected item without confirmation" -- Needs review
