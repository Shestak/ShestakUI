...
L_INFO_SETTINGS_KLE = "Type /settings kle, to apply the settings KLE."
...
L_POPUP_SETTINGS_ALL = "Apply settings for all modifications? (DBM/DXE/KLE, Skada and MSBT)"
...
L_POPUP_SETTINGS_KLE = "Need to change the position of elements KLE."
