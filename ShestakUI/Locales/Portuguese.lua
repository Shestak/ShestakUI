...
L_WELCOME_LINE_3 = "Nota: esta versão do ShestakUI é editado por Oz de shestak.org."
...
-- Hide Button
L_HIDE_BUTTON_1 = "Left click = esconder chat"
L_HIDE_BUTTON_2 = "Clique direito = esconder minimap (apenas fora de combate)"
