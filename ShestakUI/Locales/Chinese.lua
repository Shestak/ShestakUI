...
L_INFO_SETTINGS_KLE = "键入 /settings kle, 载入 KLE 的设定."
...
L_POPUP_SETTINGS_ALL = "应用所有的插件设置? (DBM/DXE/KLE, Skada and MSBT)"
L_POPUP_SETTINGS_DBM = "需要改变DBM描点及风格化元素."
L_POPUP_SETTINGS_DXE = "需要改变DXE描点及风格化元素."
L_POPUP_SETTINGS_KLE = "需要改变KLE描点及风格化元素."
