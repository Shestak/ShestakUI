...
L_STATS_HR = "小时"
L_STATS_INF = "无限"
L_STATS_ALREADY_ADDITIONS = "is already in additions list." -- Need review
...
L_STATS_CLEARED_JUNK = "Junk list cleared." -- Need review
L_STATS_CLEAR_ADDITIONS = "Clear additions list." -- Need review
L_STATS_KILLS = "击杀"
...
L_STATS_RC_AUTO_REPAIRING1 = "右键显示自动修装"
L_STATS_RC_AUTO_REPAIRING2 = "Middle-Click toggles Guild AutoRepairing." -- Need review
L_STATS_EQUIPMENT_CHANGER = "Shift-Click or Alt-Click for equipment set changer." -- Need review
