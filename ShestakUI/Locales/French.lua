...
L_SLASHCMD_HELP = {
	...
	"/dis ADDON_NAME - Desactive nom_addon.",
	"/en ADDON_NAME - Active nom_addon.",
	"/rd - Dissout le groupe ou raid.",
	"/toraid - Active le mode raid.",
	"/teleport - Teleportation dans le donjon aleatoire en cours.",
	"/luaerror ON|OFF - Active/Desactive l'affiche des erreurs LUA.",
	"/spec, /ss - Bascule d'une specialisation talent a l'autre.",
	...
	"/moveui - Permet de deplacer des elements de l'interface.",
	"/resetui - Remet les parametres generaux a leurs valeurs par defaut.",
	"/resetuf - Remet les cadres d'unite a leur position par defaut.",
	"/resetconfig - Remet les parametres ShestakUI_Config a leurs valeurs par defaut.",
	"/resetstats - Remet a zero les statitisques or et temps passe en jeu.",
	"/settings ADDON_NAME - Applique les parametres pour msbt, dbm, skada, ou a tous les addons.",
	...
	"/tt - Chuchote a la cible.",
	"/ainv - Active l'invitation automatique.",
	"/testuf - Lance un test des cadres d'unite.",
	"/cfg - Ouvre les parametres de l'interface.",
}