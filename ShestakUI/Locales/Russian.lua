...
L_CHAT_INSTANCE_CHAT = "ПБ"
L_CHAT_INSTANCE_CHAT_LEADER = "ЛПБ"
L_CHAT_OFFICER = "О"
...
L_POPUP_TALENT_FIX = "Произошла ошибка Blizzard, которая мешает сменить таланты. К сожалению, мы не можем ничего сделать для решения проблемы в этом патче. Пожалуйста, перезагрузите интерфейс и попробуйте ещё раз."
...
L_WELCOME_LINE_3 = "Примечание: данная версия ShestakUI изменена Oz." -- Thanks to Shestak for translation
