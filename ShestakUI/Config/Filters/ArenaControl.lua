...
T.ArenaControl = {
	...
	-- BETA [GetSpellInfo(115001)] = 5,	-- Remorseless Winter
	-- Druid
	...
	-- BETA [GetSpellInfo(44572)] = 5,	-- Deep Freeze
	...
	-- BETA [GetSpellInfo(119392)] = 5,	-- Charging Ox Wave
	-- Paladin
	[GetSpellInfo(853)] = 5,	-- Hammer of Justice
	-- BETA [GetSpellInfo(105593)] = 5,	-- Fist of Justice
	...
	-- BETA [GetSpellInfo(137143)] = 5,	-- Blood Horror
	...
	--BETA [GetSpellInfo(114238)] = 4,	-- Fae Silence
	-- BETA [GetSpellInfo(102051)] = 4,	-- Frostjaw
	...
	--BETA [GetSpellInfo(111340)] = 3,	-- Ice Ward
	[GetSpellInfo(116706)] = 3,	-- Disable
	--BETA [GetSpellInfo(87194)] = 3,	-- Glyph of Mind Blast
	[GetSpellInfo(114404)] = 3,	-- Void Tendril's Grasp
	--BETA [GetSpellInfo(63685)] = 3,	-- Frozen Power
