...
local Update = function(self, event, unit)
	...
	local r, g, b, t
	--BETA if(power.colorTapping and not UnitPlayerControlled(unit) and UnitIsTapped(unit) and not UnitIsTappedByPlayer(unit) and not UnitIsTappedByAllThreatList(unit)) then
