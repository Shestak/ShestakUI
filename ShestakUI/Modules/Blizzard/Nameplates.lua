...
local goodR, goodG, goodB = unpack(SettingsCF.nameplate.good_color)
local nearR, nearG, nearB = unpack(SettingsCF.nameplate.near_color)
local badR, badG, badB = unpack(SettingsCF.nameplate.bad_color)
...
local threatUpdate = function(self, elapsed)
	...
	if self.elapsed >= 0.2 then
		...
		self.healthBar:SetHeight(SettingsCF.nameplate.height)
		self.healthBar:SetWidth(SettingsCF.nameplate.width)
...
local updatePlate = function(self)
	...
	self.castBar:SetHeight(SettingsCF.nameplate.height)
	self.castBar:SetWidth(SettingsCF.nameplate.width)
...
local fixCastbar = function(self)
	...
	self:SetHeight(SettingsCF.nameplate.height)
	self:ClearAllPoints()
