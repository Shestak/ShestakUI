...
frame:SetScript("OnEvent", function(self, event, addon)
	...
	SetFont(GameTooltipHeader, NORMAL, GetLocale() == "zhTW" and 14 or 12, nil, nil, nil, nil, 0, 0, 0, 1, -1)
	...
	SetFont(SubZoneTextString, NORMAL, 24, "OUTLINE")
...
if LSM then
	LSM:Register(LSM.MediaType.FONT, "Fira Sans Condensed", C.media.normal_font, LOCALE_MASK)
