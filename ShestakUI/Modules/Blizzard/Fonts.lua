...
UIFonts:SetScript("OnEvent", function(self, event, addon)
	...
	SetFont(GameTooltipHeader, NORMAL, GetLocale() == "zhTW" and 14 or 13)
	SetFont(Tooltip_Med, NORMAL, GetLocale() == "zhTW" and 12 or 11)
	SetFont(Tooltip_Small, NORMAL, GetLocale() == "zhTW" and 11 or 10)
	SetFont(GameTooltipTextSmall, NORMAL, GetLocale() == "zhTW" and 12 or 11)
