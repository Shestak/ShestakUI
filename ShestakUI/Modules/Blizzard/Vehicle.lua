...
VehicleAnchor:Point(unpack(C.position.vehicle))
...
VehicleAnchor:SetTemplate("Transparent")
VehicleAnchor:SetBackdropBorderColor(1, 0, 0)
VehicleAnchor:SetAlpha(0)
VehicleAnchor.text = VehicleAnchor:CreateFontString("VehicleAnchorText", "OVERLAY")
VehicleAnchor.text:SetFont(C.media.pixel_font, C.media.pixel_font_size, C.media.pixel_font_style)
