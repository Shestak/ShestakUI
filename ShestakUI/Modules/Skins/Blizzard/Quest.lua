...
local function LoadSkin()
	...
	--BETA QuestDetailScrollFrame:StripTextures(true)
	QuestDetailScrollChildFrame:StripTextures(true)
	--BETA QuestRewardScrollFrame:StripTextures(true)
	QuestRewardScrollChildFrame:StripTextures(true)
	--BETA QuestProgressScrollFrame:StripTextures(true)
	--BETA QuestGreetingScrollFrame:StripTextures(true)
