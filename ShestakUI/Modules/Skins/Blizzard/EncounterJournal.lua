...
local function LoadSkin()
	...
	EncounterJournalInstanceSelectSuggestTab:SkinButton(true)
	EncounterJournalInstanceSelectDungeonTab:SkinButton(true)
	EncounterJournalInstanceSelectRaidTab:SkinButton(true)
	EncounterJournalInstanceSelectLootJournalTab:SkinButton(true)
