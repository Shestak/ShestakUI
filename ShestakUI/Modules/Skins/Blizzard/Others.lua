...
SkinBlizzUI:SetScript("OnEvent", function(self, event, addon)
	...
	if addon == "ShestakUI" then
		...
		--BETA _G["ChannelPulloutTabText"]:ClearAllPoints()
		...
		--BETA _G["ChannelPulloutTabLeft"]:SetTexture(nil)
		...
		--BETA T.SkinCloseButton(_G["ChannelPulloutCloseButton"])
		T.SkinCloseButton(_G["RolePollPopupCloseButton"])
		T.SkinCloseButton(_G["ItemRefCloseButton"])
		--BETA T.SkinCloseButton(_G["BNToastFrameCloseButton"])
