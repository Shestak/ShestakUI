...
StaticPopupDialogs["BW_TEST"] = {
	...
	OnAccept = function()
		BigWigs.pluginCore.modules.Bars.db.profile.barStyle = "ShestakUI"
		BigWigs.pluginCore.modules.Bars.db.profile.font = SettingsCF.font.stylization_font
		BigWigs.pluginCore.modules.Messages.db.profile.font = SettingsCF.media.normal_font
		BigWigs.pluginCore.modules.Messages.db.profile.outline = "OUTLINE"
		BigWigs.pluginCore.modules.Proximity.db.profile.font = SettingsCF.media.normal_font
