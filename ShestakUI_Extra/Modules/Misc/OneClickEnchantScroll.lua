...
----------------------------------------------------------------------------------------
--	Create enchantment scrolls with one click(OneClickEnchantScroll by Sara.Festung)
----------------------------------------------------------------------------------------
local LoadOCES = CreateFrame("Frame")
LoadOCES:RegisterEvent("ADDON_LOADED")
LoadOCES:SetScript("OnEvent", function(self, event, addon)
